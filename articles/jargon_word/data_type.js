...
👋 Hello `JavaScript Enthusiasts!` আজকে আমরা জাভাস্ক্রিপ্ট এর ডাটা টাইপ নিয়ে এটা একটু জানার চেষ্টা করব
...
👉 **Primitive Value** হচ্ছে সিঙ্গেল একটা ভ্যালু, যেই ভ্যালুর কোন `properties` এবং `methods` নেই এবং এটি `immutable` মানে এই ভ্যালুকে কোন পরিবর্তন করা যায় না 🙃
...
🎗️ জাভাস্ক্রিপ্টে সকল `Reference/Complex` ডাটার টাইপ হচ্ছে `object`
