👋 Hello `JavaScript Enthusiasts!` আজকে আমরা জভাস্ক্রিপ্ট এর `split()` মেথড কিভাবে কাজ করে এটা একটু জানার চেষ্টা করব

✅ জাভাস্ক্রিপ্টের `split()` মেথড যেকোনো স্ট্রিং এর উপর এপ্লাই করতে হয় । এই মেথড যেকোনো স্ট্রিং কে বিভক্ত করে `substrings` গুলো নিয়ে নতুন একটি `Array` তৈরী করে রিটার্ন করে। অরিজিনাল স্ট্রিং কে কোনো ধরনের পরিবর্তন করে না । কেননা, আমরা সবাই এটা জানি যে JavaScript এর সকল Primitive Data হচ্ছে `immutable` । সো অরিজিনাল স্ট্রিং কে পরিবর্তন করার কোন প্রশ্নই আসে না। এটা জাভাস্ক্রিপ্টের `ECMAScript1 (ES1)` এর ফিচার । একে স্ট্রিং হেলপার মেথড ও বলা হয় ।
